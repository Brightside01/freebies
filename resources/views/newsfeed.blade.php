    	...
    	<div class="container">
          ...
          ================================================= -->
            ...
            <div id="chat-block">
              ...
              <ul class="online-users list-inline">
                ...
                <li><a href="newsfeed-messages.html" title="John Doe"><img src="{{asset('images/users/user-4.jpg')}}" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="newsfeed-messages.html" title="Alexis Clark"><img src="{{asset('images/users/user-5.jpg')}}" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="newsfeed-messages.html" title="James Carter"><img src="{{asset('images/users/user-6.jpg')}}" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="newsfeed-messages.html" title="Robert Cook"><img src="{{asset('images/users/user-7.jpg')}}" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="newsfeed-messages.html" title="Richard Bell"><img src="{{asset('images/users/user-8.jpg')}}" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="newsfeed-messages.html" title="Anna Young"><img src="{{asset('images/users/user-9.jpg')}}" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="newsfeed-messages.html" title="Julia Cox"><img src="{{asset('images/users/user-10.jpg')}}" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
              </ul>
            </div><!--chat block ends-->
          </div>
    			<div class="col-md-7">
            ...
            <div class="post-content">
              <img src="{{asset('images/post-images/1.jpg')}}" alt="post-image" class="img-responsive post-image" />
              <div class="post-container">
                ...
                <div class="post-detail">
                  ...
                  <div class="post-comment">
                    <img src="{{asset('images/users/user-4.jpg')}}" alt="" class="profile-photo-sm" />
            ...
            <div class="post-content">
              ...
              <div class="post-container">
                <img src="{{asset('images/users/user-3.jpg')}}" alt="user" class="profile-photo-md pull-left" />
                <div class="post-detail">
                  <div class="user-info">
                  ...
                  <div class="line-divider"></div>
                   <div class="post-comment">
                    <img src="{{asset('images/users/user-14.jpg')}}" alt="" class="profile-photo-sm" />
                  ...
                  <div class="post-comment">
                    <img src="{{asset('images/users/user-2.jpg')}}" alt="" class="profile-photo-sm" />
            ...
            <div class="post-content">
              <div class="post-container">
                <img src="{{asset('images/users/user-2.jpg')}}" alt="user" class="profile-photo-md pull-left" />
                <div class="post-detail">
                  <div class="user-info">
                  ...
                  <div class="line-divider"></div>
                  <div class="post-comment">
                    <img src="{{asset('images/users/user-12.jpg')}}" alt="" class="profile-photo-sm" />
            ...
            ================================================= -->
            <div class="post-content">
              <img src="{{asset('images/post-images/2.jpg')}}" alt="post-image" class="img-responsive post-image" />
              <div class="post-container">
                <img src="{{asset('images/users/user-4.jpg')}}" alt="user" class="profile-photo-md pull-left" />
                <div class="post-detail">
                  <div class="user-info">
                  ...
                  <div class="line-divider"></div>
                  <div class="post-comment">
                    <img src="{{asset('images/users/user-13.jpg')}}" alt="" class="profile-photo-sm" />
                  ...
                  <div class="post-comment">
                    <img src="{{asset('images/users/user-8.jpg')}}" alt="" class="profile-photo-sm" />
            ...
            ================================================= -->
            <div class="post-content">
              <img src="{{asset('images/post-images/11.jpg')}}" alt="" class="img-responsive post-image" />
              <div class="post-container">
                <img src="{{asset('images/users/user-9.jpg')}}" alt="user" class="profile-photo-md pull-left" />
                <div class="post-detail">
                  <div class="user-info">
                  ...
                  <div class="line-divider"></div>
                  <div class="post-comment">
                    <img src="{{asset('images/users/user-10.jpg')}}" alt="" class="profile-photo-sm" />
          ...
          ================================================= -->
            ...
            <div class="suggestions" id="sticky-sidebar">
              ...
              <div class="follow-user">
                <img src="{{asset('images/users/user-13.jpg')}}" alt="" class="profile-photo-sm pull-left" />
                <div>
              ...
              <div class="follow-user">
                <img src="{{asset('images/users/user-14.jpg')}}" alt="" class="profile-photo-sm pull-left" />
                <div>
              ...
              <div class="follow-user">
                <img src="{{asset('images/users/user-15.jpg')}}" alt="" class="profile-photo-sm pull-left" />
                <div>
