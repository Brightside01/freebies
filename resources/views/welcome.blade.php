...
<!-- Mirrored from themified.com/friend-finder/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jan 2022 23:01:03 GMT -->
<head>
    ...
    <!--Favicon-->
    <link rel="shortcut icon" type="{{asset('image/png" href="images/fav.png')}}"/>
	</head>
	<body>
    ...
    ================================================= -->
        ...
        <div class="sign-up-form">
					<a href="index.html" class="logo"><img src="{{asset('images/logo.png')}}" alt="Friend Finder"/></a>
		...
		<section id="app-download">
			<div class="container wrapper">
				...
				<ul class="app-btn list-inline slideUp">
					<li><button class="btn-secondary"><img src="{{asset('images/app-store.png')}}" alt="App Store" /></button></li>
					<li><button class="btn-secondary"><img src="{{asset('images/google-play.png')}}" alt="Google Play" /></button></li>
				</ul>
				<h2 class="sub-title">stay connected anytime, anywhere</h2>
				<img src="{{asset('images/iPhone.png')}}" alt="iPhone" class="img-responsive" />
			</div>
		</section>
		...
		<section id="live-feed">
			<div class="container wrapper">
				...
				<ul class="online-users list-inline slideUp">
					<li><a href="#" title="Alexis Clark"><img src="{{asset('images/users/user-5.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
          <li><a href="#" title="James Carter"><img src="{{asset('images/users/user-6.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
          <li><a href="#" title="Robert Cook"><img src="{{asset('images/users/user-7.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
          <li><a href="#" title="Richard Bell"><img src="{{asset('images/users/user-8.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
          <li><a href="#" title="Anna Young"><img src="{{asset('images/users/user-9.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
          <li><a href="#" title="Julia Cox"><img src="{{asset('images/users/user-10.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
				</ul>
				<h2 class="sub-title">see what’s happening now</h2>
				<div class="row">
					<div class="col-md-4 col-sm-6 col-md-offset-2">
						<div class="feed-item">
							<img src="{{asset('images/users/user-1.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
						...
						<div class="feed-item">
							<img src="{{asset('images/users/user-4.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
							<div class="live-activity">
						...
						<div class="feed-item">
							<img src="{{asset('images/users/user-10.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
							<div class="live-activity">
						...
						<div class="feed-item">
							<img src="{{asset('images/users/user-3.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
							<div class="live-activity">
						...
						<div class="feed-item">
							<img src="{{asset('images/users/user-2.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
							<div class="live-activity">
					...
					<div class="col-md-4 col-sm-6">
						<div class="feed-item">
							<img src="{{asset('images/users/user-17.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
							<div class="live-activity">
						...
						<div class="feed-item">
							<img src="{{asset('images/users/user-18.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
							<div class="live-activity">
						...
						<div class="feed-item">
							<img src="{{asset('images/users/user-11.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
							<div class="live-activity">
						...
						<div class="feed-item">
							<img src="{{asset('images/users/user-16.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
							<div class="live-activity">
      ...
      <div class="container">
          ...
          <div class="footer-wrapper">
            <div class="col-md-3 col-sm-3">
              <a href="#"><img src="{{asset('images/logo-black.png')}}" alt="" class="footer-logo" /></a>
    ...
    <!--Buy button-->
    <!-- <a href="https://themeforest.net/cart/add_items?item_ids=18711273&amp;ref=thunder-team" target="_blank" class="btn btn-buy"><span class="italy">Buy with:</span><img src="{{asset('images/envato_logo.png')}}" alt="" /><span class="price">Only $20!</span></a> -->
...
<!-- Mirrored from themified.com/friend-finder/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jan 2022 23:01:09 GMT -->
</html>
